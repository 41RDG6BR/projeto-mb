      ...
      {registers.map((registro) => (
        <li
          ...
          style={{
            backgroundColor:
              coresDisciplinas[
                registro.disciplina as keyof typeof coresDisciplinas
              ],
          }}
        >
          <div className='delete-container'>
            <div
              onClick={() => onDelete(Number(registro.id))}
          ...
          <div className='card-content'>
            ...
            >
              ...
              <div className='nota-container'>Nota: {registro.nota}</div>
            </div>
          </div>
        </li>
      ))}
